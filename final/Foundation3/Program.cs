...
class Program
{
    ...
    {
        Lecture lecture = new Lecture("Lagrangian points", "Come hear a fascinating speech on the secret regions of space where gravity itself cancels out.", "September 15th, 2008", "7:00PM", "Dr. Andrew Lariviere", 125);
